...
## User Story
- Với vai trò là **Quản trị viên**, tôi muốn thêm mới danh mục Loại giao dịch công chứng.
...
## Luồng chính
1. Người dùng chọn chức năng **Thêm mới danh mục Loại giao dịch công chứng** từ menu (**DM_LoaiGDCC_Create**).
2. Hệ thống hiển thị form thêm mới danh mục (**DM_LoaiGDCC_Create**).
...
## Liên kết
- Activity Diagram: [DM_LoaiGDCC_Create.puml]
